...
/**
 * Controller class for the HonestlyNeverMind.fxml file.
 * 
 * This class manages the behavior and events of the HonestlyNeverMind view. It
 * implements the Initializable interface to initialize the view. The view
 * displays an image, buttons, and a table view. The buttons allow navigation to
 * other views, and the table view shows data.
 * 
 * @author Enric&Miriam
 * @version v1
 *
 */
public class HonestlyNeverMindController implements Initializable {
	@FXML
	...
	/**
	 * Event listener for the HonestlyNeverMind button. This method is
	 * auto-generated and needs to be implemented.
	 *
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		MyMethods.fillTable("Honestly,Nevermind", Tablageneral);
