 ...
 * interface.
 * 
 * This class manages the behavior and events of the Bad view. It initializes
 * the view and defines actions for the buttons. The view displays an image, a
 * table, and several buttons. The buttons allow navigation to other views and
 * closing the application. The table displays data with columns for name and
 * duration. The data is filled using the MyMethods.fillTable() method.
 * 
 * @author Enric&Miriam
 * @version v1
 *
 */
public class BleachController implements Initializable {
	@FXML
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		MyMethods.fillTable("Bleach", Tablageneral);
